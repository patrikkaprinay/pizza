...
const Info = () => {
  return (
    <div className="py-14">
      ...
      <div className="w-full lg:w-4/6 xl:w-3/6 md:w-5/6 md:mx-auto md:rounded-md py-8 text-2xl md:text-xl bg-orange-500 text-white my-7 font-bold font-roboto-s">
