  ...
  return (
    <div className="h-70 bg-gray-300 w-full flex justify-center items-center pb-1">
      <div className="container mx-auto text-center">
        <div className="w-4/5 md:w-4/5 lg:w-3/5 xl:w-2/5 mx-auto grid grid-cols-1 sm:grid-cols-2 divide-y sm:divide-x sm:divide-y-0 divide-gray-500 py-4 sm:py-10">
          <div className="text-4xl py-8 flex justify-center items-center">
            <Logo />
          </div>
