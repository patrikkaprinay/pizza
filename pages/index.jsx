    ...
    <div className="pt-16">
      <main className="pt-28">
        <div className="container mx-auto">
          ...
          <div className="flex justify-center items-center flex-col bg-gray-300 py-8 bg-opacity-90 rounded-lg">
            <h1 className="text-center font-praise text-8xl sm:text-10xl">
              Pizza Milano
            </h1>
